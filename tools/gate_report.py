...
def write_provenance(s):
    ...
    L = ["# v2 provenance register", "",
         ...
         "on every calibratable YAML leaf, meaning a terminal setting in the config tree. NB this is a YAML leaf, not a DAG leaf: the node graph has its own 16 childless nodes and the two counts are unrelated. This file is a readable view of that, nothing more. "
